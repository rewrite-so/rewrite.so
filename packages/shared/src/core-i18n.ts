...
const CORE_MESSAGES: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'core.retry': 'Retry',
    'core.copy': 'Copy',
    'core.writeFailed': "Can't write to this editor — copy instead",
  ...
  'zh-CN': {
    ...
    'core.retry': '重试',
    'core.copy': '复制',
    'core.writeFailed': '无法写入此编辑器 —— 请手动复制',
  ...
  ja: {
    ...
    'core.retry': '再試行',
    'core.copy': 'コピー',
    'core.writeFailed': 'このエディタには書き込めません — コピーしてください',
  ...
  ko: {
    ...
    'core.retry': '재시도',
    'core.copy': '복사',
    'core.writeFailed': '이 편집기에 쓸 수 없습니다 — 복사하세요',
  ...
  es: {
    ...
    'core.copy': 'Copiar',
    'core.writeFailed': 'No se puede escribir en este editor — copia en su lugar',
  ...
  fr: {
    ...
    'core.copy': 'Copier',
    'core.writeFailed': "Impossible d'écrire dans cet éditeur — copiez à la place",
  ...
  de: {
    ...
    'core.copy': 'Kopieren',
    'core.writeFailed': 'Kann nicht in diesen Editor schreiben — bitte kopieren',
